...
<body class="bg-light">
    ...
    <main class="shadow-lg mb-5">
        <form class="form-horizontal was-validated" method="POST" action="alteracao.php?id=<?php echo $dados['id']; ?>">

            <div class="form-group">
                <label>Título</label>
                <input type="text" name="titulo" value="<?php echo $dados['titulo']; ?>" class="form-control w-100" placeholder="Título do artigo" required minlength="5">
            </div>
            <div class="form-group  ">
                <label>Conteúdo</label>
                <textarea class="form-control" name="conteudo" rows="25" minlength="15" maxlength="8000" required><?php echo $dados['conteudo']; ?></textarea>
            </div>
            <div class="form-group">
