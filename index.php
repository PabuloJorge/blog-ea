...
<body class="bg-light">
    ...
    <main>
        ...
        $sql = "SELECT * FROM tb_artigo WHERE status = 'ativo' ORDER BY id DESC";
        ...
        ?>
            <div class="artigo mb-5 p-3 shadow-lg text-justify">
                ...
                <pre><?php echo substr($dados['conteudo'], 0, 300)."..." ?>
                </pre>
                <a class="btn btn-primary" href="./lerMais.php?id=<?php echo $dados['id'] ?>">Ler mais</a>
            </div>
        <?php
        }
        ?>
